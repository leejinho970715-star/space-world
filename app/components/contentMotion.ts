...
const headlineSelector=".story-line strong,.section-head h2,.belt-copy h2,.galaxy-copy h2,.satellite-copy h2,.weather-heading h2,.transition-copy h2,.deep-title h2,.planet-copy h3,.object-meta h3,.finale h2,.detail-copy h2";
const numberSelector=".altimeter b,.planet-index,.planet-copy dd,.object-meta b,.signal-detail strong,.galaxy-sticky dd,.satellite-copy dd,.weather-grid strong,.journey-step b,.detail-copy dd,.detail-visual>span";
