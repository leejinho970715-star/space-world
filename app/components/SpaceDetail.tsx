...
export default function SpaceDetail({section,title,lede,items}:{section:string;title:string;lede:string;items:Item[]}){
 ...
 return <main ref={root} className="subpage"><header className="topbar solid"><a className="brand" href="/"><span className="brand-mark">C</span>COSMOS <b>/ AR</b></a><nav><a href="/planets">Planets</a><a href="/deep-space">Deep space</a><a href="/orbit-data">Orbit data</a></nav><a className="back-home" href="/">← Field guide</a></header>
   ...
   </article>)}</section><footer><a className="brand" href="/"><span className="brand-mark">C</span>COSMOS <b>/ AR</b></a><p>A FIELD GUIDE TO THE OBSERVABLE UNIVERSE.</p><small>© 2026 COSMOS AR LAB</small></footer>
 </main>
}
